...
class ThemeProvider {
  static const appColor = Color.fromARGB(255, 230, 87, 4);
  static const secondaryAppColor = Color.fromARGB(255, 222, 106, 23);
...
ThemeData light = ThemeData(
    ...
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        ...
        unselectedItemColor: ThemeProvider.greyColor,
...
ThemeData dark = ThemeData(
    ...
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        ...
        selectedItemColor: ThemeProvider.whiteColor),
    textTheme: txtTheme,
